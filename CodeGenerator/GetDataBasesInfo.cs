...
namespace CodeGenerator
{
    ...
    public class DataBasesInfo
    {
        ...
        public DataBasesInfo(string _name, string _uid, string _pwd)
        {
            this.Name = _name;
            this.uid = _uid;
            this.pwd = _pwd;
        ...
        /// 打开连接的方法
        /// </summary>
        private void Connect(bool LoginSecure)
        {
            ser = new Server();
            if (!LoginSecure)
            {
        ...
        /// <returns></returns>
        //public DataTable GetTableClomns(string dbName, Table table)
        //{
        ...
        //            dr["AllowNull"] = col.Nullable;
        //            dr["MaxLength"] = col.DataType.MaximumLength;
        //            dr["Des"] = col.ExtendedProperties.Count > 0 ? col.ExtendedProperties[0].Value : string.Empty;
        //            dt.Rows.Add(dr);
        //        }
        //    }
        //    return dt;
